...
function navi(){ 
  var menu = [
    ...
    ['Network', 'sabainet', 0, 
      [
        ['Basic',  'sabainet-basic.php', 'basic'],
        ['Advanced',  'sabainet-advanced.php', 'advanced'],
        ['Wireless', 'sabainet-wireless.php', 'wireless']
      ] 
    ],
    ['VPN', 'sabaivpn', 0, 
      [
  ...
  for (i=0; i<menu.length; i++) {
    ...
    if( menu[i][0] == 'VPN' | menu[i][0] == 'Network'| menu[i][0] == 'Diagnostics') {
      $('#navButtons').append(
